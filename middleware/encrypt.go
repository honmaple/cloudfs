...
import (
	...
	"github.com/honmaple/cloudfs/middleware/aes"
)
...
func (opt *EncryptOption) NewFS(fs cloudfs.FS) (cloudfs.FS, error) {
...
var _ cloudfs.FS = (*encryptFS)(nil)
...
func newEncryptFS(fs cloudfs.FS, opt *EncryptOption) (cloudfs.FS, error) {
	if opt.Password == "" {
...
func EncryptFS(opt *EncryptOption) cloudfs.WrapFunc {
	return opt.NewFS
}
